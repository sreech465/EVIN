...
const SparePartScreen = ({navigation, route}) => {
  ...
  const {supplier_equipment_name, model_name, spare_parts, line_id,id,equipment_id,tagged_equipment_name} =
    ...
    <SafeAreaView
      ...
      <View style={component.header}>
        <View style={component.headerDetail}>
          <View style={{flex: 0.9}}>
            <Text style={[appStyle.H6, {color: '#FFFFFF'}]}>Spare Parts</Text>
          ...
          <View style={{flex: 0.6}}>
            <View
              style={{
                ...
                backgroundColor:checkedData.length>0?'rgba(50, 139, 203, 1)':'rgba(50, 139, 203, 0.5)',
      ...
      <SafeAreaView style={component.box2}>
        ...
        <View
          style={{
            ...
            marginBottom:Platform.OS==='android'?heightToDp('16'):heightToDp('13'),
              ...
              renderItem={(item, index) => {
                ...
                return (
                  <Pressable
                    ...
                    onPress={() =>
                     {
                      if( item.item.available==='Yes' && item.item.vendor_name==="Self" ){
