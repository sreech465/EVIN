      ...
      <View
        ...
        <View
          ...
          <Image
            ...
            style={[
              ...
              {
                marginTop:
                  Platform.OS == 'ios' ? heightToDp('2.5') : heightToDp('2'),
              },
            ]}
          />
        </View>
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            <View style={{flex: 1}}>
              <Text style={appStyle.lightGrayText}>Project</Text>
        ...
        ProjectList.data.results.length > 0 ? (
          ...
          <View
            style={{
              backgroundColor: '#F4F7FF',
              marginBottom:
                Platform.OS == 'ios' ? heightToDp('15') : heightToDp('16'),
            }}>
            <FlatList
